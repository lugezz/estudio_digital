    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('activo', 'activo'), ('inactivo', 'inactivo')], default='activo', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='direccion_empresa', to='common.Address')),
            ],
            options={
                'ordering': ['-is_active'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=50)),
                ('tipo_iva', models.CharField(choices=[('nacional', 'Nacional'), ('provincial', 'Provincial'), ('municipal', 'Municipal')], default='nacional', max_length=20)),
                ('periodicidad', models.CharField(choices=[('mensual', 'Mensual'), ('anual', 'Anual'), ('trimestral', 'Trimestral')], default='mensual', max_length=20)),
        ...
        migrations.AddField(
            model_name='emp_user',
            name='empresa',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.Empresa'),
        ),
        migrations.AddField(
            model_name='emp_user',
            name='user',
        ...
        migrations.AddField(
            model_name='emp_imp',
            name='impuesto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.Impuesto'),
        ),
    ]
